...
Begin VB.Form ABMClientes 
   ...
   Begin TabDlg.SSTab Frame8 
      ...
      Tab(0).Control(9)=   "cboPais"
      Tab(0).Control(9).Enabled=   0   'False
      Tab(0).Control(10)=   "cboIva"
...
Dim tiposEstablecimiento(18) As String
...
Private Sub WriteToLog(logFile As String, message As String)
    ...
    On Error Resume Next ' Ignorar errores al abrir el archivo
...
Private Sub Form_Load()
    ...
    tiposEstablecimiento(17) = "FIBROSCOPIA"
