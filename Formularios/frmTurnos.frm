...
Private Sub cmdAgregar_Click()
    ...
    'For i = 1 To nFilaH - nFilaD
        ...
        If MsgBox("緿esea imprimir el Turno?", vbQuestion + vbYesNo, TIT_MSGBOX) = vbNo Then
'
...
Private Sub cmdDrive_Click()
    ...
    Else
        MsgBox "No tienes configurado el link a los protocolos. Por favor contacta al administrador", vbExclamation, "Informaci髇"
    End If
End Sub
...
Private Sub BuscarTurnos(Fecha As Date, Doc As Integer)
    ...
    sql = "SELECT TOP 100 T.*,V.VEN_NOMBRE,C.CLI_RAZSOC,C.CLI_NRODOC,C.CLI_TELEFONO,C.CLI_CELULAR,C.CLI_CUMPLE, C.CLI_LINKARCH"
