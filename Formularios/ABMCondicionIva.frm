VERSION 5.00
Begin VB.Form ABMCondicionIva 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Datos de la Condición I.V.A."
   ClientHeight    =   2025
   ClientLeft      =   2700
   ClientTop       =   2625
   ClientWidth     =   4530
   ...
   Begin VB.CommandButton cmdAyuda 
      Height          =   315
      Left            =   210
      Picture         =   "ABMCondicionIva.frx":000C
      Style           =   1  'Graphical
      TabIndex        =   6
      Top             =   1605
      Width           =   330
   ...
   End
End
Attribute VB_Name = "ABMCondicionIva"
...
Const cTabla = "CONDICION_IVA"
Const cCampoID = "IVA_CODIGO"
Const cDesRegistro = "Condición I.V.A."
    ...
    If Validar(vMode) = True Then
        ...
        Select Case vMode
            Case 1 'nuevo
                ...
                cSQL = cSQL & "     (IVA_CODIGO, IVA_DESCRI) "
                cSQL = cSQL & "VALUES "
            ...
            Case 2 'editar
                ...
                cSQL = cSQL & "     IVA_DESCRI = " & XS(txtDescri.Text)
                cSQL = cSQL & " WHERE IVA_CODIGO  = " & XN(txtID.Text)
            
            Case 4 'eliminar
            
                cSQL = "DELETE FROM " & cTabla & " WHERE IVA_CODIGO  = " & XN(txtID.Text)
...
Private Sub Form_Load()
    ...
    If vMode <> 1 Then
        If vFieldID <> "0" Then
            cSQL = "SELECT * FROM " & cTabla & "  WHERE IVA_CODIGO = " & Mid(vFieldID, 2, Len(vFieldID) - 2)
            rec.Open cSQL, DBConn, adOpenStatic, adLockOptimistic
            If (rec.BOF And rec.EOF) = 0 Then
                'si encontró el registro muestro los datos
                txtID.Text = rec!IVA_CODIGO
                txtDescri.Text = rec!IVA_DESCRI
            Else
                Beep
