VERSION 5.00
Begin VB.Form ABMTipoGatos 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Datos de Tipo de Gastos..."
   ClientHeight    =   2025
   ClientLeft      =   2700
   ClientTop       =   2625
   ClientWidth     =   4530
   ...
   End
End
Attribute VB_Name = "ABMTipoGatos"
...
Const cTabla = "TIPO_GASTO"
Const cCampoID = "TGT_CODIGO"
Const cDesRegistro = "Tipo Gasto"
...
Function SetMode(pMode As Integer)
    ...
    Select Case pMode
        Case 1
            ...
            Me.Caption = "Nuevo Tipo Gasto..."
            txtID_LostFocus
            DesacCtrl txtID
        Case 2
            cmdAceptar.Enabled = False
            Me.Caption = "Editando Tipo Gasto..."
            DesacCtrl txtID
        Case 3
            cmdAceptar.Visible = False
            Me.Caption = "Datos del Tipo Gasto..."
            DesacCtrl txtID
        Case 4
            cmdAceptar.Enabled = True
            Me.Caption = "Eliminando Tipo Gasto..."
            DesacCtrl txtID
    End Select
    ...
    If Validar(vMode) = True Then
        ...
        Select Case vMode
            Case 1 'nuevo
                ...
                cSQL = cSQL & "     (TGT_CODIGO, TGT_DESCRI) "
                cSQL = cSQL & "VALUES "
            ...
            Case 2 'editar
                ...
                cSQL = cSQL & "     TGT_DESCRI = " & XS(txtDescri.Text)
                cSQL = cSQL & " WHERE TGT_CODIGO  = " & txtID.Text
            
            Case 4 'eliminar
            
                cSQL = "DELETE FROM " & cTabla & " WHERE TGT_CODIGO  = " & txtID.Text
...
Private Sub Form_Load()
    ...
    If vMode <> 1 Then
        If vFieldID <> "0" Then
            cSQL = "SELECT * FROM " & cTabla & "  WHERE TGT_CODIGO = " & Mid(vFieldID, 2, Len(vFieldID) - 2)
            rec.Open cSQL, DBConn, adOpenStatic, adLockOptimistic
            If (rec.BOF And rec.EOF) = 0 Then
                'si encontró el registro muestro los datos
                txtID.Text = rec!TGT_CODIGO
                txtDescri.Text = rec!TGT_DESCRI
            Else
                Beep
